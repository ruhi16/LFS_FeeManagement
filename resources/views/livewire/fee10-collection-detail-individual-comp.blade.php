<div>
    ...
    {{--  --}}
    <div class="bg-white shadow rounded-lg p-6 max-w-4xl mx-auto" id="receipt-container">
        <!-- School Header -->
        <div class="text-center mb-6 border-b pb-4">
            <h1 class="text-2xl font-bold text-blue-800">ABC Public School</h1>
            <p class="text-gray-600">123 Education Street, Knowledge City</p>
        ...
        <div class="mt-8 p-4 bg-gray-50 rounded-lg">
            <div class="mb-4">
                <div class="flex items-center gap-2 mb-2">
                    <div class="px-3 py-1 bg-gray-200 text-lg font-mono rounded" id="captcha-text">A7B9C</div>
                    <button onclick="generateCaptcha()" class="text-blue-600 hover:text-blue-800">
